                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Align(
                      ...
                      child: Text('닉네임', style: TextStyle(color: PicpleColors.primary1, fontSize: 16)),
                    ),
                  ),
                  Padding(
                    ...
                    child: AppTextField(
                      ...
                      hintText: '닉네임을 입력하세요',
                      hintStyle: const TextStyle(color: PicpleColors.gray3, fontSize: 18),
                      ...
                      borderRadius: 12,
                      borderWidth: 1.0,
                      suffixIconAsset: state.nickname.isNotEmpty ? 'assets/icons/ic_close.svg' : null,
                      onSuffixIconPressed: () => ref.read(profileEditStateProvider.notifier).setNickname(''),
